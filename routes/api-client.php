...
use Pterodactyl\Http\Controllers\Api\Client\Billing as ClientBilling;
...
Route::get('/billing/packages', [ClientBilling\PackageController::class, 'index'])->name('api:client.billing.packages');
