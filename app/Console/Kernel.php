...
use Pterodactyl\Console\Commands\Server\SuspendExpiredServersCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command(SuspendExpiredServersCommand::class)->everyMinute()->withoutOverlapping();
