...
class ServersController extends Controller
{
     ...
     * @throws \Pterodactyl\Exceptions\Repository\RecordNotFoundException
     */
    public function toggleInstall(Request $request, Server $server): RedirectResponse
    {
        if ($request->filled('update_expiration')) {
            return $this->updateExpiration($request, $server);
        }
    ...
    /**
     * Update the expiration date for a server.
     */
    public function updateExpiration(Request $request, Server $server): RedirectResponse
    {
        ...
        $this->alert->success('Server expiration has been updated.')->flash();
